...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Vestido Feminino 80,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0088.jpg" alt="" title="Vestido Feminino" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar7.php" method="POST">
              <fieldset>
                <ol>
