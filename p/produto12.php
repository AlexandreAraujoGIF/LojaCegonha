...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Shampoo, Condicionador e creme de pentar Zoo Pers R$: 110,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0073.jpg" alt="" title="Shampoo, Condicionador e creme de pentar Zoo Pers" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar12.php" method="POST">
              <fieldset>
                <ol>
