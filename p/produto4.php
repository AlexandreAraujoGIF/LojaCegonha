...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Kit de mamadeiras-feminino R$: 82,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0031.jpg" alt="" title="Kit de mamadeiras-feminino" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar4.php" method="POST">
              <fieldset>
                <ol>
