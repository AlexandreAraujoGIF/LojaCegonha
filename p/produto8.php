...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Roupinha de salva-vidas R$: 45,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0057.jpg" alt="" title="Roupinha de salva-vidas" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar8.php" method="POST">
              <fieldset>
                <ol>
