...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Conjunto Social R$: 98,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0090.jpg" alt="" title="Conjunto Social" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar9.php" method="POST">
              <fieldset>
                <ol>
