...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Kit de mamadeiras R$: 40,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0063.jpg" alt="" title="Kit de mamadeiras" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar13.php" method="POST">
              <fieldset>
                <ol>
