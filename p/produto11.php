...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Fralda Turma da monica Tamanho P R$: 67,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/IMG-20180224-WA0075.jpg" alt="" title="Fralda Turma da monica Tamanho P" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar11.php" method="POST">
              <fieldset>
                <ol>
