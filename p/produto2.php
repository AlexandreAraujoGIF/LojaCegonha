...
<div id="wrapper">
    ...
    <!-- Begin Content -->
    <div id="content">
    <h1 class="title" >Boneco dos Minions R$: 50,00</h1>
    <div class="line"></div>

<div>
<img src="../style/images/fotos/27.jpeg" alt="" title="Boneco dos Minions" /></a>
<br><br><br>
    <!-- Begin Form -->
          <div class="form-container">
            <form class="forms" action="adicionar2.php" method="POST">
              <fieldset>
                <ol>
